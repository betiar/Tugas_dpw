...
<!--  Modal -->
      ...
      <!-- HERO SECTION-->
      <div class="container">
        <section class="hero pb-3 bg-cover bg-center d-flex align-items-center" style="background: url({{'public'}}/distribution/img/hero-banner-alt.jpg)">
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6">
              <div class="product text-center">
                <div class="position-relative mb-3">
                  <div class="badge text-white badge-"></div><a class="d-block" href="{{'public'}}/distribution/detail.html"><img style="width: 400px; height: 300px;" class="img-fluid w-100" src="{{url("public/$produk->gambar")}}" alt="..."></a>
        ...
        <section class="py-5">
          <div class="container p-0">
            <div class="row">
              ...
              <div class="col-lg-6">
                <form action="mailto: amaliabetiar@gmail.com">
